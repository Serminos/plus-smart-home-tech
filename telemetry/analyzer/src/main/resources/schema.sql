...
-- создаЄм таблицу scenario_conditions, св€зывающую сценарий и условие активации сценари€
...
-- создаЄм таблицу scenario_actions, св€зывающую сценарий, действие, которое нужно выполнить при активации сценари€
